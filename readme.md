...
```
<sup>[snippet source](/src/LocalDb/Wrapper.cs#L233-L236)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/src/EfLocalDb/SqlInstance.cs#L202-L210)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/src/EfLocalDb/SqlInstance.cs#L180-L189)</sup>
<!-- endsnippet -->
