...
{
```
<sup>[snippet source](/src/EfLocalDb/SqlInstance.cs#L106-L119)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/src/EfLocalDb/SqlInstance.cs#L126-L134)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/src/EfLocalDb/SqlInstance.cs#L84-L93)</sup>
<!-- endsnippet -->
