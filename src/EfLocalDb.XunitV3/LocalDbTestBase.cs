    ...
    where T : DbContext
{
    ...
    public async Task Reset()
    {
        ...
        var type = context.TestClass?.TestClassName!;
        var member = GetMemberName(context);
    ...
    static string GetMemberName(ITestContext context)
    {
        var method = context.TestMethod?.MethodName!;
        var arguments = (context.Test as IXunitTest)?.TestMethodArguments;
