    ...
    where T : DbContext
{
    ...
    public virtual Task SetUp(TestContext context)
    {
        if (sqlInstance == null)
        {
    ...
    {
        phase = Phase.Arrange;
        var type = TestContext.Current!.Metadata.TestDetails.ClassType.FullName!;
    ...
    static string GetMemberName()
    {
        ...
        var method = details.TestName;
        var arguments = details.TestMethodArguments;
