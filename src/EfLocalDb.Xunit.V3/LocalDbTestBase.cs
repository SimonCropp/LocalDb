    ...
    where T : DbContext
{
        ...
        DateTime? timestamp = null)
    {
        ...
        ReportTrxGuard.ThrowIfModuleInitializer("an assembly fixture registered with [assembly: AssemblyFixture]");
        ThrowIfInitialized();
        sqlInstance = new(
    ...
    MethodInfo GetCurrentMethodInfo()
    {
        ...
        return GetType()
            ...
            .First(_ => _.Name == testMethodName && !_.IsGenericMethod);
    }
    ...
    {
        var method = TestContext.Current.TestMethod!.MethodName;
        var test = TestContext.Current.Test;
        object?[]? arguments = null;
        if (test is IXunitTest xunitTest)
        {
            arguments = xunitTest.TestMethodArguments;
        }
